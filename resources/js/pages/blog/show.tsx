        ...
        <>
            ...
            <main>
                <article className="mx-auto max-w-3xl px-6 pb-20 pt-12 sm:pt-20">
                    ...
                    <h1 className="mt-5 text-4xl font-bold tracking-tight text-surface-950 sm:text-6xl">{post.title}</h1>
                    <p className="mt-6 text-xl leading-8 text-surface-600">{post.excerpt}</p>
