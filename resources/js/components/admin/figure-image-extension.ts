...
export const FigureImage = Node.create({
        ...
        return [{
            ...
            getAttrs: (element) => {
                ...
                return {
                    ...
                    caption: figure.querySelector('[data-caption]')?.textContent || '',
                    source: figure.querySelector('[data-source]')?.textContent || '',
    ...
    renderHTML({ HTMLAttributes }) {
        ...
        return [
            'figure',
            mergeAttributes({ 'data-type': 'figure-image', 'data-size': size || 'full' }),
