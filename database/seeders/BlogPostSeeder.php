    ...
    public function run(): void
    {
        $posts = [
            ...
            [
                ...
                'content' => '<p>Production mobile development is less about arranging widgets and more about handling uncertainty.</p><h2>Treat permissions as a flow</h2><p>Location, camera, and notification permissions are states, not one-time dialogs.</p><h2>Separate environments early</h2><p>Development, staging, and production should have explicit configuration.</p><h2>Log useful context</h2><p>When a request fails, record the endpoint, status, environment, and relevant application state without leaking sensitive data.</p>',
